...
namespace Character.Battle.Model
{
    ...
    {
        public HeroBattleModel(int id, int level, int xp, CharacterAttributes attributes, PersistantDataManager persistentDataManager) : base(id, level, xp, attributes, persistentDataManager)
        {
